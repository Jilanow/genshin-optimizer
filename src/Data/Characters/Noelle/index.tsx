...
const translate = (strKey: string) => <Translate ns="char_noelle" key18={strKey} />
...
const char: ICharacterSheet = {
  ...
  gender: "F",
  constellationName: translate("constellationName"),
  ...
  talent: {
    auto: {
      name: translate("auto.name"),
      img: normal,
      document: [{
        text: translate("auto.fields.normal"),
        ...
        text: translate("auto.fields.charged"),
        fields: [{
          text: `Spinning DMG`,
        ...
        text: translate("auto.fields.plunging"),
        fields: [{
          text: `Plunge DMG`,
    ...
    skill: {
      ...
      img: skill,
      document: [{
        text: translate("skill.description"),
        fields: [{
          text: "Skill DMG",
    ...
    burst: {
      name: translate("burst.name"),
      img: burst,
      document: [{
        text: translate("burst.description"),
        fields: [{
          text: "Burst DMG",
    ...
    passive1: {
      name: translate("passive1.name"),
      img: passive1,
      document: [{
        text: translate("passive1.description"),
        fields: [{
    ...
    passive2: {
      name: translate("passive2.name"),
      img: passive2,
      document: [{
        text: translate("passive2.description"),
      }],
    },
    passive3: {
      name: translate("passive3.name"),
      img: passive3,
      document: [{
        text: translate("passive3.description"),
      }]
    },
    constellation1: {
      name: translate("constellation1.name"),
      img: c1,
      document: [{ text: translate("constellation1.description"), }]
    },
    constellation2: {
      name: translate("constellation2.name"),
      img: c2,
      document: [{ text: translate("constellation2.description"), }],
      stats: {
        charged_dmg_: 15,
    ...
    constellation3: {
      name: translate("constellation3.name"),
      img: c3,
      document: [{ text: translate("constellation3.description"), }],
      stats: { skillBoost: 3 }
    },
    constellation4: {
      name: translate("constellation4.name"),
      img: c4,
      document: [{
        text: translate("constellation4.description"),
        fields: [{
    ...
    constellation5: {
      name: translate("constellation5.name"),
      img: c5,
      document: [{ text: translate("constellation5.description"), }],
      stats: { burstBoost: 3 }
    },
    constellation6: {
      name: translate("constellation6.name"),
      img: c6,
      document: [{ text: translate("constellation6.description"), }]
    }
  }
};
export default char;
