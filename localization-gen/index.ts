...
const languageData = {}
Object.entries(languageMap).forEach(([lang, strings]) => {
  crawlObject(data, [], v => typeof v != "object", (value, keys) => {
    if (typeof value === "number") {
      const [type, characterKey, skill, field] = keys
      let string = strings[value] as string
      if (skill === "auto" && field === "name") {
